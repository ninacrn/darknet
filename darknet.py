...
class DETECTION(ct.Structure):
    _fields_ = [("bbox", BOX),
                ...
                ("sort_class", ct.c_int),
                ("uc", ct.POINTER(ct.c_float)),
                ("points", ct.c_int),
                ("embeddings", ct.POINTER(ct.c_float)),
...
class DETNUMPAIR(ct.Structure):
    _fields_ = [("num", ct.c_int),
                ("dets", ct.POINTER(DETECTION))]
...
get_network_boxes.argtypes = [ct.c_void_p, ct.c_int, ct.c_int, ct.c_float, ct.c_float, ct.POINTER(
    ct.c_int), ct.c_int, ct.POINTER(ct.c_int), ct.c_int]
...
free_batch_detections.argtypes = [ct.POINTER(DETNUMPAIR), ct.c_int]
...
predict_image_letterbox.restype = ct.POINTER(ct.c_float)

network_predict_batch = lib.network_predict_batch
network_predict_batch.argtypes = [ct.c_void_p, IMAGE, ct.c_int, ct.c_int, ct.c_int,
                                  ct.c_float, ct.c_float, ct.POINTER(ct.c_int), ct.c_int, ct.c_int]
network_predict_batch.restype = ct.POINTER(DETNUMPAIR)
